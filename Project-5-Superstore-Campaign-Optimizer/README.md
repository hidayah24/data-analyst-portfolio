...
## Data
### Raw Data
- **File Name**: `supersotore_data.csv`
- **Source**: [Superstore Marketing Campaign Dataset](https://www.kaggle.com/datasets/ahsan81/superstore-marketing-campaign-dataset)
- **Dataset Size**: ... rows, ... columns
### DB
- **File Name**: `superstore.duckdb`
- **Source**: Converted file from CSV to database (duckdb)